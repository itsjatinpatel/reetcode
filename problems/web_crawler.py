...
class Solution:
    def _hostname(self, statUrl: str) -> str:
        return statUrl.split("/")[2]
    ...
    def crawl(self, startUrl: str, htmlParser: "HtmlParser") -> list[str]:
        ...
        while queue:
            ...
            for nested_url in htmlParser.getUrls(url):
                if nested_url in visited or self._hostname(nested_url) != hostname:
                    continue
